  ...
  <div class="row">
         ...
         <div class="row row-cols-1">
            <div class="d-slider1 overflow-hidden swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
               <Swiper  id="swiper-wrapper-bb5b4e5553f7a9a4" aria-live="polite" :options="newoptions">
                  <SwiperSlide class="swiper-slide card card-slide swiper-slide-active" role="group" aria-label="1 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                  ...
                  <SwiperSlide class="swiper-slide card card-slide swiper-slide-next" role="group" aria-label="2 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                  ...
                  <SwiperSlide class="swiper-slide card card-slide" role="group" aria-label="3 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                  ...
                  <SwiperSlide class="swiper-slide card card-slide" role="group" aria-label="4 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                  ...
                  <SwiperSlide class="swiper-slide card card-slide" role="group" aria-label="5 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                  ...
                  <SwiperSlide class="swiper-slide card card-slide" role="group" aria-label="6 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                  ...
                  <SwiperSlide class="swiper-slide card card-slide" role="group" aria-label="7 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
      ...
      <div class="col-md-12 col-lg-8">
         <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
               <iq-card bodyClass="p-0" headerClass="flex-wrap">
                  <template v-slot:headerTitle>
